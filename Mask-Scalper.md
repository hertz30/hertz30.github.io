...
* Directed a cross-functional team of four: A developer (Nicholas), an artist (Trent), and a composer (Austin), as well as myself.
    ...
    * For our presentation, Trent and Austin were out of town, while Nicholas had stayed up all night working on the game and was out of commission, so I presented the project as the primary team representative. 
